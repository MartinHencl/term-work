...
CREATE TABLE IF NOT EXISTS `term_db`.`VOZIDLO` (
  ...
  `SPZ` VARCHAR(150) NOT NULL,
  `PUVODNI_NAJETO` DATETIME NOT NULL,
  `SPOTREBA` INT UNSIGNED NULL,
  `DOJEZD_NA_NADRZ` INT UNSIGNED NULL,
  `VYBAVENI_ID_VYBAVENI` INT UNSIGNED NOT NULL,
  `ZNACKA_VOZU_ID_ZNACKA_VOZU` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`ID_VOZIDLA`),
  INDEX `fk_VOZIDLO_VYBAVENI1_idx` (`VYBAVENI_ID_VYBAVENI` ASC) ,
  INDEX `fk_VOZIDLO_ZNACKA_VOZU1_idx` (`ZNACKA_VOZU_ID_ZNACKA_VOZU` ASC) ,
  CONSTRAINT `fk_VOZIDLO_VYBAVENI1`
...
ALTER DATABASE db_dev CHARACTER SET = utf8mb4 COLLATE utf8mb4_unicode_ci;	-- kodovani utf8mb4